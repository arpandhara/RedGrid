...
// 1. Import the Onboarding Wizard
import OnboardingWizard from "../../components/onboarding/OnboardingWizard";

const HospitalDashboard = () => {
  const { user } = useAuthStore();

  // 2. Add Safety Check for User & Onboarding Status
  ...
  return (
    <div className={`relative min-h-screen ${needsOnboarding ? "h-screen overflow-hidden" : ""}`}>
      ...
      {/* 3. Render Onboarding Overlay if needed */}
      {needsOnboarding && (
      ...
      {/* 4. Apply Blur Effect to Dashboard Content when Onboarding is active */}
