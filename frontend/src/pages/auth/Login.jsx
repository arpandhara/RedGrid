...
const Login = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen flex bg-white dark:bg-zinc-950 font-sans selection:bg-red-500/20 overflow-hidden"
    >
      ...
      <div className="hidden lg:flex lg:w-[45%] relative bg-black items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 p-12 text-white max-w-lg">
          ...
          <h1 className="sidebar-content text-5xl font-bold mb-6 leading-tight">
            Welcome Back.
          </h1>
          <p className="sidebar-content text-xl text-gray-300 mb-8 font-light">
            Your contribution makes a difference. Access your dashboard to
          ...
          <div className="sidebar-content bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6">
            <div className="text-sm text-gray-300 uppercase tracking-widest mb-1">
        ...
        <div ref={formRef} className="w-full max-w-md">
          ...
          <div className="relative mb-8 form-element">
            ...
            <div className="relative flex justify-center text-xs uppercase tracking-widest">
              <span className="bg-white dark:bg-zinc-950 px-4 text-gray-400">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2 form-element">
              ...
              <input
                ...
                required
                className="w-full px-4 py-3.5 bg-gray-50 dark:bg-zinc-900 border border-transparent dark:border-zinc-800 rounded-xl focus:bg-white dark:focus:bg-black focus:border-red-500 focus:ring-4 focus:ring-red-500/10 outline-none transition-all"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="form-element w-full py-4 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-red-500/30 hover:shadow-red-500/50 hover:scale-[1.01] active:scale-[0.98] flex items-center justify-center gap-2 group"
            >
              {isLoading ? (
